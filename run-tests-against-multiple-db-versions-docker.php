...
$container_creation_commands = [
     ...
     [
         'postgres:14.22' => [
             'run_container' => "docker run --rm --name {$runtime_name_placeholder} -dt -p 5432:5432 -e POSTGRES_HOST_AUTH_METHOD=trust -e POSTGRES_DB=blog docker.io/library/postgres:14.22",
             'dsn' => $pgsql_dsn,
             'username' => $pgsql_user,
             'password' => $pgsql_pass,
         ], 
    ...
    [
        'mysql:9.6.0' => [
            'run_container' => "docker run --rm --name {$runtime_name_placeholder} -dt -p 3306:3306 -e MYSQL_ROOT_PASSWORD={$mysql_root_psw} docker.io/library/mysql:9.6.0",
            'dsn' => $mysql_maria_db_sql_dsn,
            'username' => $mysql_user,
            'password' => $mysql_root_psw,
        ],
    ...
    [
         'postgres:15.17' => [
             'run_container' => "docker run --rm --name {$runtime_name_placeholder} -dt -p 5432:5432 -e POSTGRES_HOST_AUTH_METHOD=trust -e POSTGRES_DB=blog docker.io/library/postgres:15.17",
             'dsn' => $pgsql_dsn,
             'username' => $pgsql_user,
             'password' => $pgsql_pass,
         ], 
     ...
     [
         'postgres:16.13' => [
             'run_container' => "docker run --rm --name {$runtime_name_placeholder} -dt -p 5432:5432 -e POSTGRES_HOST_AUTH_METHOD=trust -e POSTGRES_DB=blog docker.io/library/postgres:16.13",
             'dsn' => $pgsql_dsn,
             'username' => $pgsql_user,
             'password' => $pgsql_pass,
         ], 
     ...
     [
         'postgres:17.9' => [
             'run_container' => "docker run --rm --name {$runtime_name_placeholder} -dt -p 5432:5432 -e POSTGRES_HOST_AUTH_METHOD=trust -e POSTGRES_DB=blog docker.io/library/postgres:17.9",
             'dsn' => $pgsql_dsn,
             'username' => $pgsql_user,
             'password' => $pgsql_pass,
         ], 
     ...
     [
         'postgres:18.3' => [
             'run_container' => "docker run --rm --name {$runtime_name_placeholder} -dt -p 5432:5432 -e POSTGRES_HOST_AUTH_METHOD=trust -e POSTGRES_DB=blog docker.io/library/postgres:18.3",
             'dsn' => $pgsql_dsn,
             'username' => $pgsql_user,
             'password' => $pgsql_pass,
         ], 
